    ...
    $('.portfolio-image li').each(function(){
      ...
      if(vUrl != '')
      {
        if( vUrl.substring(0,4) == 'live' )
        {
          ...
          var image_url = 'assets/mobile/images/bon_tv.jpg';
          if( has_image,length > 0 )
          {
            image_url = has_image.text();
          }
          var liveVid = vUrl.substring(4);
          $('#polyv-'+vUrl).append('<a href="http://live.polyv.cn/watch/'+liveVid+'" class="video-link"><img class="video-image" src="'+image_url+'"><img class="video-link-button" src="assets/mobile/images/button-play.png"></a>');
        }
        else{
